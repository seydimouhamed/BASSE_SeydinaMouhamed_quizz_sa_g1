...
<div class="container-fluid col-md-10 col-lg-10 col-sm-10 col-10  justify-content-center">
    ...
    <div class="row bg-grey justify-content-around border-white border col-md-11 col-lg-11 col-sm-11 col-11 ">
        <span id="lock_user"><img src="./public/images/icones/lock_open-24px.svg" alt="dqs"></span>
        <span id="unlock_user"><img src="./public/images/icones/lock-24px.svg" alt="dqs"></span>
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
                type: "POST",
                url: `${URL}=services&action=getUsers`,
